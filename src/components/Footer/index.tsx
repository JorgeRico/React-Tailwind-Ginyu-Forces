        ...
        <>
            <div className="bg-black text-white p-10 w-full flex items-center justify-center flex-col">
                ...
                <div className="flex flex-items justify-center w-auto gap-10 mb-15">
                    ...
                    <img src="../assets/sponsors/babidi.png" alt="Babidi" className="h-20 mr-4 bg-white p-3" />
                    <img src="../assets/sponsors/roshi.png" alt="Mutenroshi" className="h-20 mr-4 bg-white p-3" />
                    <img src="../assets/sponsors/muten.png" alt="King Mutenroshi" className="h-20 mr-4 bg-white p-3" />
                </div>
            </div>
