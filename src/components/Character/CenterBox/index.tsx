            ...
            <div className="bg-gray-400/30 text-white rounded-md px-7 overflow-hidden transition-all duration-750">
                <div className="flex flex-wrap mt-6">
                    <div className="flex flex-unwrap items-justify items-center capitalize text-emerald-700 font-bold w-18">
                        <img src="./src/assets/balls/ball1.png" className="w-5.5 border-2 border-amber-500 rounded-full mt-0.5 mr-2"></img>
                ...
                <div className="flex flex-wrap mt-3">
                    <div className="flex flex-unwrap items-justify items-center capitalize text-emerald-700 font-bold w-18">
                        <img src="./src/assets/balls/ball2.png" className="w-5.5 border-2 border-amber-500 rounded-full mt-0.5 mr-2"></img>
                ...
                <div className="flex flex-wrap mt-3">
                    <div className="flex flex-unwrap items-justify items-center capitalize text-emerald-700 font-bold w-18">
                        <img src="./src/assets/balls/ball3.png" className="w-5.5 border-2 border-amber-500 rounded-full mt-0.5 mr-2"></img>
                ...
                <div className="flex flex-wrap mt-3">
                    <div className="flex flex-unwrap items-justify items-center capitalize text-emerald-700 font-bold w-18">
                        <img src="./src/assets/balls/ball4.png" className="w-5.5 border-2 border-amber-500 rounded-full mt-0.5 mr-2"></img>
                ...
                <div className="flex flex-wrap mt-4 mb-5">
                    <a href="#" className="flex flex-wrap items-justify items-center hover:underline text-black">
                        <img src="./src/assets/balls/balls-online.png" className="w-20"></img>
